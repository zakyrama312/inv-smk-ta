<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Kelola Kondisi</h2>
            <p class="text-gray-600 mt-1">Manajemen Kondisi</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr wire:key="kondisi-{{ $kondisi->id }}" class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {{ $kondisis->firstItem() + $index }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="ml-4">
                                    <div class="text-sm font-semibold text-gray-900">{{ $kondisi->nama_kondisi }}
                                    </div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded-full">
                                {{ $kondisi->barangs_count }} Barang
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            <button wire:click="edit({{ $kondisi->id }})"
                            ...
                            <button wire:click="delete({{ $kondisi->id }})"
                                wire:confirm="Apakah Anda yakin ingin menghapus kondisi ini?"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Tidak ada data Kondisi</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div x-data="{ open: true }" x-show="open" x-transition.opacity
        ...
        <div x-transition class="relative w-full max-w-md p-6 bg-white rounded-2xl shadow-xl border border-gray-100">
            ...
            <div>
                ...
                <input type="text" wire:model.defer="nama_kondisi"
