<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Kelola Users</h2>
                    ...
                    <tr wire:key="user-{{ $user->id }}" class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    class="shrink-0 h-10 w-10 bg-linear-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center">
                                    <span
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span @class([ 'px-3 py-1 text-xs font-semibold rounded-full' , 'bg-red-100 text-red-800'=>
                                $user->role === 'admin',
                                'bg-blue-100 text-blue-800' => $user->role === 'kaprodi',
                                'bg-green-100 text-green-800' => $user->role === 'anggota',
                                ])>
                                {{ ucfirst($user->role) }}
                            </span>
                ...
                <form wire:submit.prevent="save" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model="name" type="text" id="name"
                            @class([ 'bg-gray-50 border text-gray-900 text-sm placeholder-gray-400 rounded-lg block w-full p-2.5 focus:ring-blue-500 focus:border-blue-500'
                    ...
                    <!-- Prodi (hanya untuk kaprodi dan anggota) -->
                    @if(in_array($role, ['kaprodi', 'anggota']))
                    <div>
                        <label for="prodi_id" class="block mb-2 text-sm font-medium text-gray-900">
                            Prodi <span class="text-red-500">*</span>
                        </label>
                        <select wire:model="prodi_id" id="prodi_id"
                            @class([ 'bg-gray-50 border text-gray-900 text-sm placeholder-gray-400 rounded-lg block w-full p-2.5 focus:ring-blue-500 focus:border-blue-500'
                            , 'border-gray-300'=> !$errors->has('prodi_id'),
                            'border-red-500' => $errors->has('prodi_id'),
                            ])
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="text-white bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all">
