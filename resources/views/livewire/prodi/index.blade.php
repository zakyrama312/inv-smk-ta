<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Kelola Prodi</h2>
            <p class="text-gray-600 mt-1">Manajemen Prodi</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr wire:key="prodi-{{ $prodi->id }}" class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-gray-900">{{ $prodi->nama_prodi }}
                                </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                            ...
                            <button wire:click="delete({{ $prodi->id }})"
                                wire:confirm="Apakah Anda yakin ingin menghapus prodi ini?"
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Tidak ada data Prodi</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
    ...
    <div x-data="{ open: true }" x-show="open" x-transition.opacity
        ...
        <div x-transition class="relative w-full max-w-md p-6 bg-white rounded-2xl shadow-xl border border-gray-100">
            ...
            <div>
                ...
                <input type="text" wire:model.defer="nama_prodi"
