<div>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Kelola Ruang</h2>
            <p class="text-gray-600 mt-1">Manajemen Ruang</p>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr wire:key="ruang-{{ $ruang->id }}" class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="text-sm font-semibold text-gray-900">{{ $ruang->nama_ruang }}
                                </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded-full">
                                {{ $ruang->barangStoks_count }} Barang
                            </span>
                        </td>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-500">Tidak ada data ruang</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div x-transition class="relative w-full max-w-md p-6 bg-white rounded-2xl shadow-xl border border-gray-100">
            ...
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-semibold text-gray-800">
                    {{ $isEdit ? 'Edit Ruang' : 'Tambah Ruang' }}
                </h2>
            ...
            <div>
                ...
                <input type="text" wire:model.defer="nama_ruang"
