        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative w-80">
                ...
                <input wire:model.live.debounce.300ms="search" type="text"
                    class="block w-full pl-10 pr-3 py-2 text-sm border placeholder-gray-400 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="flex items-center gap-2">
                ...
                <input wire:model.live="filterTanggalSelesai" type="date"
                    class="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">

                <!-- Reset Button -->

                @if($search || $filterStatus || $filterTanggalMulai || $filterTanggalSelesai)
